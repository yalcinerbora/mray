...
{
    assert(e < MRayTextureInterpEnum::MR_ENUM_END);
    return Names[static_cast<uint32_t>(e)];
}
...
{
    assert(e < MRayTextureEdgeResolveEnum::MR_ENUM_END);
    return Names[static_cast<uint32_t>(e)];
}
...
{
    assert(e < MRayTextureReadMode::MR_ENUM_END);
    return Names[static_cast<uint32_t>(e)];
}
