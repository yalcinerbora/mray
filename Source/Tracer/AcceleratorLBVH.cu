...
template MRAY_DEVICE_ALGO_SEG_TRANSFORM_REDUCE_TM_SIZE_SIGNATURE(AABB3, PrimitiveKey);
template MRAY_DEVICE_ALGO_SEG_TRANSFORM_REDUCE_TM_SIZE_SIGNATURE(AABB3, AABB3);
template MRAY_DEVICE_ALGO_SEG_TRANSFORM_REDUCE_SIGNATURE(AABB3, AABB3, UnionAABB3Functor, IdentityFunctor<AABB3>);
template MRAY_DEVICE_ALGO_SEG_RADIX_SORT_TM_SIZE_SIGNATURE(true, uint64_t, uint32_t);
template MRAY_DEVICE_ALGO_SEG_RADIX_SORT_SIGNATURE(true, uint64_t, uint32_t);
